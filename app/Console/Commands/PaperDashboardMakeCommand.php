...
namespace Atnic\PaperDashboard\Console\Commands;

use Illuminate\Console\Command;

class PaperDashboardMakeCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'make:paper-dashboard {--views : Only scaffold the views}';
     ...
     * @var string
     */
    protected $description = 'Scaffold basic make:auth with Paper Dashboard Template';
    ...
    public function handle()
    {
        ...
        $this->info('Start Paper Dashboard scaffolding');
        ...
        $this->info('Paper Dashboard scaffolding generated successfully.');
    }
